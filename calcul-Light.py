...
class Calculator:
    def __init__(self, root):
        ...
        self.total_label = tk.Label(self.display_frame, text=self.total_expression, anchor=tk.E, bg="white",
                                    fg="#4E505F",
    ...
    def create_digit_and_operator_buttons(self):
        for digit, grid_value in self.digits.items():
            tk.Button(self.buttons_frame, text=str(digit), bg="#D2D3DA", fg="black", font=("Arial", 24, "bold"),
    ...
    def create_special_buttons(self):
        primaryColorLight = "#4B5EFC"
        tk.Button(self.buttons_frame, text="C", bg="#D2D3DA", fg="black", font=("Arial", 20), borderwidth=0,
